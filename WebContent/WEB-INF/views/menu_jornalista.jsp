...
<body>
	...
	<h2>Bem-Vindo, ${usuario_jornalista.nomeCompleto}!</h2>
	
	<a href="cadastrarNoticiaFormulario"> Cadastrar Noticia</a> <br />
	<a href="mostrarNoticiaJornalista?usuarioId=${usuario_jornalista.usuarioId}"> Minhas notícias</a>
